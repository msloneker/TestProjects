...
import 'fourth_page_model.dart';
export 'fourth_page_model.dart';

class FourthPageWidget extends StatefulWidget {
  const FourthPageWidget({Key? key}) : super(key: key);
...
class _FourthPageWidgetState extends State<FourthPageWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FourthPageModel());
  }
          ...
          child: Column(
            ...
            children: [
              Padding(
                ...
                child: Text(
                  'Which Star Wars series/trilogy is your favorite?',
                  ...
                  Align(
                    ...
                    child: FlutterFlowRadioButton(
                      options: [
                        ...
                        'Sequel Trilogy (7, 8, & 9)',
                        'Other (Solo, Andor, Obi-Wan Kenobi, Ahsoka, etc.)'
                      ].toList(),
